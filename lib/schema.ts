...
async function createSchema() {
  ...
  await db.query(`
    ...
    CREATE INDEX IF NOT EXISTS interviewslot_lookup_idx
      ON public.interviewslot(date, "startTime", "endTime");
    ...
    CREATE TABLE IF NOT EXISTS public.interviewbooking (
      ...
      email TEXT NOT NULL,
      company TEXT,
      "interviewType" TEXT NOT NULL DEFAULT 'Job Interview',
      "meetingLink" TEXT,
      message TEXT,
      date TIMESTAMPTZ NOT NULL,
      "startTime" TEXT NOT NULL,
    ...
    CREATE TABLE IF NOT EXISTS public.admin_activity_replies (
      id BIGSERIAL PRIMARY KEY,
    ...
    CREATE INDEX IF NOT EXISTS admin_activity_replies_lookup_idx
      ON public.admin_activity_replies(record_type, record_id, sent_at DESC);
    ...
    CREATE TABLE IF NOT EXISTS public.admin_password_credentials (
  ...
  await db.query(`
    ...
    ALTER TABLE public.interviewbooking
      ADD COLUMN IF NOT EXISTS "interviewType" TEXT DEFAULT 'Job Interview';
    ...
    ALTER TABLE public.interviewbooking
      ADD COLUMN IF NOT EXISTS "slotId" BIGINT;
    ...
    CREATE INDEX IF NOT EXISTS contactmessage_created_idx
      ON public.contactmessage("createdAt" DESC);

    CREATE INDEX IF NOT EXISTS interviewbooking_created_idx
      ON public.interviewbooking("createdAt" DESC);

    CREATE INDEX IF NOT EXISTS interviewbooking_date_idx
      ON public.interviewbooking(date DESC);
  `);
